...
public final class RecognizeConceptsActivity extends BaseActivity {
  ...
  @NonNull private final RecognizeConceptsAdapter adapter = new RecognizeConceptsAdapter(this);
  ...
  @Override protected void onStart() {
    ...
    Snackbar.make(frameLayout,"Click this button to upload",Snackbar.LENGTH_SHORT).show();
  }
